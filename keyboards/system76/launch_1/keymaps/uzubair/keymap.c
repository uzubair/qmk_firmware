...
|____________|________|________|________|________|________|________|________|________|________|________|________|________|________||________|
  |            |        |        |        |        |        |        |        |        |        |   ;    |   '    |            |   |        |
  |    CAPS    |   A    |   S/3  |   D/2  |   F/1  |   G    |   H    |   J    |   K    |   L    |   :    |   "    |   ENTER    |   |  END   |
  ...
  |                |        |        |        |        |        |        |        |   ,    |    .   |   /    |            |        |
  |     SHIFT      |   Z    | X/alt  | C/ctrl | V/shf  |   B    |  N/shf | M/ctrl |   <    |    >   |   ?    |   SHIFT    |   UP   |
...
*/
  [BASE] = LAYOUT(
    ...
    KC_CAPS, KC_A,    LT(SYST,KC_S),    LT(NAVI,KC_D),    LT(SYMB,KC_F),    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_END,
    KC_LSFT, KC_Z,    MT(MOD_LALT,KC_X),    MT(MOD_LCTL,KC_C),    MT(MOD_LSFT,KC_V) ,    KC_B,   MT(MOD_RSFT,KC_N), MT(MOD_RCTL,KC_M), MT(MOD_RALT,KC_COMM), KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,
    KC_LCTL, MO(NAVI),   KC_LALT, KC_LGUI, KC_SPC,  KC_SPC,  KC_RCTL, KC_RALT, MO(NAVI),   KC_LEFT, KC_DOWN, KC_RGHT
  ),
...
*/
   [SYMB] = LAYOUT(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_GRV, KC_TILD, KC_LCBR, KC_RCBR, KC_EQL, KC_PLUS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_QUOT, KC_LPRN, KC_RPRN, KC_AMPR, KC_PIPE, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DQUO, KC_LBRC, KC_RBRC, KC_MINS, KC_UNDS, KC_TRNS, KC_TRNS,
